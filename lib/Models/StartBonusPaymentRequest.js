...
/**
 * Creates an instance of StartBonusPaymentRequest
 */
class StartBonusPaymentRequest extends BaseModel {
    /**
     * @constructor
    ...
    constructor(obj) {
        ...
        this.totalBonusAmount = this.constructor.getValue(obj.totalBonusAmount);
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'totalBonusAmount', realName: 'totalBonusAmount' },
...
module.exports = StartBonusPaymentRequest;
