...
class GetCustomerInfoResponse extends BaseModel {
    ...
    constructor(obj) {
        ...
        this.availablePoint = this.constructor.getValue(obj.availablePoint);
        this.loyaltyDiscountedPrice = this.constructor.getValue(obj.loyaltyDiscountedPrice);
    }
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'availablePoint', realName: 'availablePoint' },
            { name: 'loyaltyDiscountedPrice', realName: 'loyaltyDiscountedPrice' },
        ]);
    }
