 ...
 */
class StartMilePaymentResponse extends BaseModel {
    /**
     * @constructor
    ...
    constructor(obj) {
     ...
     || obj.miles_payment_provision_id);
        this.otpNeeded = this.constructor.getValue(obj.otpNeeded || obj.otp_needed);
    }
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'otpNeeded', realName: 'otp_needed' },
        ]);
    }
