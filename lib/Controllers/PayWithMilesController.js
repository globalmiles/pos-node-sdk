...
class PayWithMilesController {
    ...
    static deleteCancelMilePayment(milesPaymentProvisionId, body, callback) {
        ...
        let _pathUrl = '/v2/pos/payments/{miles_payment_provision_id}';
    ...
    static createStartMilePayment(body, callback) {
        ...
        const _pathUrl = '/v2/pos/payments';
        const _queryBuilder = `${_baseUri}${_pathUrl}`;
    ...
    static getMileProvisions(readCode, readCodeType, terminalId, callback) {
        ...
        if (_oAuthManager.isTokenSet()) {
            return PayWithMilesController.getMileProvisionsAction(
                _queryUrl,
                _callback,
                readCode,
                readCodeType,
        ...
        return _oAuthManager.authorize().then(
            () => PayWithMilesController.getMileProvisionsAction(
                _queryUrl,
                _callback,
                readCode,
                readCodeType,
