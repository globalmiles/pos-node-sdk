...
class CommonController {
    ...
    static getTerminalInfo(terminalId, callback) {
        ...
        const _pathUrl = '/v2/pos/terminal_info';
        ...
        return _oAuthManager.authorize().then(
            () => CommonController.getTerminalInfoAction(_queryUrl, _callback, terminalId),
            (err) => {
    ...
    static getCustomerInfo(readCode,
        ...
        const _pathUrl = '/v2/pos/customer_info';
        let _queryBuilder = `${_baseUri}${_pathUrl}`;
        ...
        if (_oAuthManager.isTokenSet()) {
            return CommonController.getCustomerInfoAction(
                _queryUrl,
                _callback,
                readCode,
                readCodeType,
        ...
        return _oAuthManager.authorize().then(
            () => CommonController.getCustomerInfoAction(
                _queryUrl,
                _callback,
                readCode,
                readCodeType,
    ...
    static uploadReceiptPictures(body, callback) {
        ...
        const _pathUrl = '/v2/pos/receipt_pictures';
        ...
        return _oAuthManager.authorize().then(
            () => CommonController.uploadReceiptPicturesAction(_queryUrl, _callback, body),
            (err) => {
                _callback(err, null, null);
                return Promise.reject(err);
            });
