...
class BonusPaymentsController {
     ...
     * @returns {Promise}
     */
    static createStartBonusPayment(body, callback) {
     ...
     * @returns {Promise}
     */
    static createCompleteBonusPayment(body, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @returns {Promise}
     */
    static createCancelBonusPayment(body, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @returns {Promise}
     */
    static createGetBonusProvisions(body, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
