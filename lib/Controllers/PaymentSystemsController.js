...
class PaymentSystemsController {
    /**
     * After getting customer info by Get customer Info API and finished the shopping procedure
     * in POS terminal, use this API to complete transaction.
     *
     ...
     * @returns {Promise}
     */
    static createTransactionResult(accept, contentType, authorization, body, callback) {
...
module.exports = PaymentSystemsController;
